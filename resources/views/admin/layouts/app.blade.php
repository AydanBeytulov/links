                        ...
                        <div class="kt-header__topbar kt-grid__item kt-grid__item--fluid">
                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                    ...
                                    <span class="kt-header__topbar-username" style="color: #636177">{{ \Illuminate\Support\Facades\Auth::user()->name }}</span>
                                    <span class="kt-header__topbar-username" style="color: #636177"> <a  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                      Logout
                                    </a></span>
                                </div>
                            </div>
