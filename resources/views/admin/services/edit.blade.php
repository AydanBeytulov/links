                ...
                <div class="kt-container  kt-grid__item kt-grid__item--fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form class="kt-form" method="post" action="{{ route('admin_services_edit_process') }}">
                                    @csrf
                                    ...
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rate" class="form-control" placeholder="Rate" value="{{ $data->rate }}" step="0.01">
                                        </div>
                                    ...
                                    <div class="kt-portlet__foot">
                                        <div class="kt-form__actions">
                                            ...
                                            <a href="{{ route('admin_services_delete',$data->id) }}" class="btn btn-danger float-right">Delete</a>
                                        </div>
                                    </div>
                                </form>
